...
test_queue_alloc(void)
{
  ...
  *ptr = 32;
  ...
  u32* val = (u32*) nex_queue_peek_head(&queue);
  ASSERT_EQ(*val, *ptr);

  val = (u32*) nex_queue_peek_tail(&queue);
  ASSERT_EQ(*val, *ptr);

  val = (u32*) nex_queue_peek_nth(&queue, 0);
  ASSERT_EQ(*val, *ptr);
  ...
  ptr = (u32*) nex_queue_peek_tail(&queue);
...
test_queue_peek_nth(void)
{
  ...
  ptr = (u32*) nex_queue_peek_nth(&queue, 0);
  ASSERT_EQ(*ptr, 0);

  ptr = (u32*) nex_queue_peek_nth(&queue, 1);
  ASSERT_EQ(*ptr, 10);

  ptr = (u32*) nex_queue_peek_nth(&queue, 2);
  ASSERT_EQ(*ptr, 20);
  
  ptr = (u32*) nex_queue_peek_nth(&queue, 3);
  ASSERT_EQ(*ptr, 30);
...
test_queue_peek_head(void)
{
  ...
  ptr = (u32*) nex_queue_peek_head(&queue);
  ASSERT_EQ(*ptr, 0);
  ptr = (u32*) nex_queue_peek_head(&queue);
  ASSERT_EQ(*ptr, 0);
  ASSERT_EQ(nex_queue_size(&queue), 4);
