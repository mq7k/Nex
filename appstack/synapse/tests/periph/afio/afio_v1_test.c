...
{
  // scope=self.reg='EVCR', self.shift=4, self.mask='0x7', self.varsmap={'port': 'AFIO_PORTA'}, self.value='0b000', self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
  ...
  // scope=self.reg='EVCR', self.shift=4, self.mask='0x7', self.varsmap={'port': 'AFIO_PORTB'}, self.value='0b001', self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
  ...
  // scope=self.reg='EVCR', self.shift=4, self.mask='0x7', self.varsmap={'port': 'AFIO_PORTC'}, self.value='0b010', self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
  ...
  // scope=self.reg='EVCR', self.shift=4, self.mask='0x7', self.varsmap={'port': 'AFIO_PORTD'}, self.value='0b011', self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
  ...
  // scope=self.reg='EVCR', self.shift=4, self.mask='0x7', self.varsmap={'port': 'AFIO_PORTE'}, self.value='0b100', self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
...
{
  // scope=self.reg='EVCR', self.shift=0, self.mask='0xf', self.varsmap={'pin': 'AFIO_PIN0'}, self.value=0, self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
  ...
  // scope=self.reg='EVCR', self.shift=0, self.mask='0xf', self.varsmap={'pin': 'AFIO_PIN1'}, self.value=1, self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
  ...
  // scope=self.reg='EVCR', self.shift=0, self.mask='0xf', self.varsmap={'pin': 'AFIO_PIN2'}, self.value=2, self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
  ...
  // scope=self.reg='EVCR', self.shift=0, self.mask='0xf', self.varsmap={'pin': 'AFIO_PIN3'}, self.value=3, self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
  ...
  // scope=self.reg='EVCR', self.shift=0, self.mask='0xf', self.varsmap={'pin': 'AFIO_PIN4'}, self.value=4, self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
  ...
  // scope=self.reg='EVCR', self.shift=0, self.mask='0xf', self.varsmap={'pin': 'AFIO_PIN5'}, self.value=5, self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
  ...
  // scope=self.reg='EVCR', self.shift=0, self.mask='0xf', self.varsmap={'pin': 'AFIO_PIN6'}, self.value=6, self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
  ...
  // scope=self.reg='EVCR', self.shift=0, self.mask='0xf', self.varsmap={'pin': 'AFIO_PIN7'}, self.value=7, self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
  ...
  // scope=self.reg='EVCR', self.shift=0, self.mask='0xf', self.varsmap={'pin': 'AFIO_PIN8'}, self.value=8, self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
  ...
  // scope=self.reg='EVCR', self.shift=0, self.mask='0xf', self.varsmap={'pin': 'AFIO_PIN9'}, self.value=9, self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
  ...
  // scope=self.reg='EVCR', self.shift=0, self.mask='0xf', self.varsmap={'pin': 'AFIO_PIN10'}, self.value=10, self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
  ...
  // scope=self.reg='EVCR', self.shift=0, self.mask='0xf', self.varsmap={'pin': 'AFIO_PIN11'}, self.value=11, self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
  ...
  // scope=self.reg='EVCR', self.shift=0, self.mask='0xf', self.varsmap={'pin': 'AFIO_PIN12'}, self.value=12, self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
  ...
  // scope=self.reg='EVCR', self.shift=0, self.mask='0xf', self.varsmap={'pin': 'AFIO_PIN13'}, self.value=13, self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
  ...
  // scope=self.reg='EVCR', self.shift=0, self.mask='0xf', self.varsmap={'pin': 'AFIO_PIN14'}, self.value=14, self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
  ...
  // scope=self.reg='EVCR', self.shift=0, self.mask='0xf', self.varsmap={'pin': 'AFIO_PIN15'}, self.value=15, self.ifdef=[], self.halt=False
  AFIO->EVCR = 0;
...
{
  // scope=self.reg='MAPR', self.shift=4, self.mask='0x3', self.varsmap={'remap': 'AFIO_REMAP_USART3_NOREMAP'}, self.value='0b00', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
  ...
  // scope=self.reg='MAPR', self.shift=4, self.mask='0x3', self.varsmap={'remap': 'AFIO_REMAP_USART3_PARTIAL'}, self.value='0b01', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
  ...
  // scope=self.reg='MAPR', self.shift=4, self.mask='0x3', self.varsmap={'remap': 'AFIO_REMAP_USART3_FULL'}, self.value='0b11', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
...
{
  // scope=self.reg='MAPR', self.shift=6, self.mask='0x3', self.varsmap={'remap': 'AFIO_REMAP_TIM1_NOREMAP'}, self.value='0b00', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
  ...
  // scope=self.reg='MAPR', self.shift=6, self.mask='0x3', self.varsmap={'remap': 'AFIO_REMAP_TIM1_PARTIAL'}, self.value='0b01', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
  ...
  // scope=self.reg='MAPR', self.shift=6, self.mask='0x3', self.varsmap={'remap': 'AFIO_REMAP_TIM1_FULL'}, self.value='0b11', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
...
{
  // scope=self.reg='MAPR', self.shift=8, self.mask='0x3', self.varsmap={'remap': 'AFIO_REMAP_TIM2_NOREMAP'}, self.value='0b00', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
  ...
  // scope=self.reg='MAPR', self.shift=8, self.mask='0x3', self.varsmap={'remap': 'AFIO_REMAP_TIM2_PARTIAL1'}, self.value='0b01', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
  ...
  // scope=self.reg='MAPR', self.shift=8, self.mask='0x3', self.varsmap={'remap': 'AFIO_REMAP_TIM2_PARTIAL2'}, self.value='0b10', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
  ...
  // scope=self.reg='MAPR', self.shift=8, self.mask='0x3', self.varsmap={'remap': 'AFIO_REMAP_TIM2_FULL'}, self.value='0b11', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
...
{
  // scope=self.reg='MAPR', self.shift=10, self.mask='0x3', self.varsmap={'remap': 'AFIO_REMAP_TIM3_NOREMAP'}, self.value='0b00', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
  ...
  // scope=self.reg='MAPR', self.shift=10, self.mask='0x3', self.varsmap={'remap': 'AFIO_REMAP_TIM3_PARTIAL'}, self.value='0b10', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
  ...
  // scope=self.reg='MAPR', self.shift=10, self.mask='0x3', self.varsmap={'remap': 'AFIO_REMAP_TIM3_FULL'}, self.value='0b11', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
...
{
  // scope=self.reg='MAPR', self.shift=13, self.mask='0x3', self.varsmap={'remap': 'AFIO_REMAP_CAN_1'}, self.value='0b00', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
  ...
  // scope=self.reg='MAPR', self.shift=13, self.mask='0x3', self.varsmap={'remap': 'AFIO_REMAP_CAN_2'}, self.value='0b10', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
  ...
  // scope=self.reg='MAPR', self.shift=13, self.mask='0x3', self.varsmap={'remap': 'AFIO_REMAP_CAN_3'}, self.value='0b11', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
...
{
  // scope=self.reg='MAPR', self.shift=24, self.mask='0x7', self.varsmap={'remap': 'AFIO_REMAP_SWJ_FULL'}, self.value='0b000', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
  ...
  // scope=self.reg='MAPR', self.shift=24, self.mask='0x7', self.varsmap={'remap': 'AFIO_REMAP_SWJ_FULL_NO_NJTRST'}, self.value='0b001', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
  ...
  // scope=self.reg='MAPR', self.shift=24, self.mask='0x7', self.varsmap={'remap': 'AFIO_REMAP_SWJ_NOJTAG'}, self.value='0b010', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
  ...
  // scope=self.reg='MAPR', self.shift=24, self.mask='0x7', self.varsmap={'remap': 'AFIO_REMAP_SWJ_NOJTAG_NOSWDP'}, self.value='0b100', self.ifdef=[], self.halt=False
  AFIO->MAPR = 0;
...
{
  // scope=self.reg='EXTICR[0]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTA', 'pin': 'AFIO_PIN0'}, self.value='0b0000', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[0]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTA', 'pin': 'AFIO_PIN1'}, self.value='0b0000', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[0]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTA', 'pin': 'AFIO_PIN2'}, self.value='0b0000', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[0]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTA', 'pin': 'AFIO_PIN3'}, self.value='0b0000', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTA', 'pin': 'AFIO_PIN4'}, self.value='0b0000', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTA', 'pin': 'AFIO_PIN5'}, self.value='0b0000', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTA', 'pin': 'AFIO_PIN6'}, self.value='0b0000', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTA', 'pin': 'AFIO_PIN7'}, self.value='0b0000', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTA', 'pin': 'AFIO_PIN8'}, self.value='0b0000', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTA', 'pin': 'AFIO_PIN9'}, self.value='0b0000', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTA', 'pin': 'AFIO_PIN10'}, self.value='0b0000', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTA', 'pin': 'AFIO_PIN11'}, self.value='0b0000', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTA', 'pin': 'AFIO_PIN12'}, self.value='0b0000', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTA', 'pin': 'AFIO_PIN13'}, self.value='0b0000', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTA', 'pin': 'AFIO_PIN14'}, self.value='0b0000', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTA', 'pin': 'AFIO_PIN15'}, self.value='0b0000', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
  ...
  // scope=self.reg='EXTICR[0]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTB', 'pin': 'AFIO_PIN0'}, self.value='0b0001', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[0]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTB', 'pin': 'AFIO_PIN1'}, self.value='0b0001', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[0]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTB', 'pin': 'AFIO_PIN2'}, self.value='0b0001', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[0]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTB', 'pin': 'AFIO_PIN3'}, self.value='0b0001', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTB', 'pin': 'AFIO_PIN4'}, self.value='0b0001', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTB', 'pin': 'AFIO_PIN5'}, self.value='0b0001', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTB', 'pin': 'AFIO_PIN6'}, self.value='0b0001', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTB', 'pin': 'AFIO_PIN7'}, self.value='0b0001', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTB', 'pin': 'AFIO_PIN8'}, self.value='0b0001', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTB', 'pin': 'AFIO_PIN9'}, self.value='0b0001', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTB', 'pin': 'AFIO_PIN10'}, self.value='0b0001', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTB', 'pin': 'AFIO_PIN11'}, self.value='0b0001', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTB', 'pin': 'AFIO_PIN12'}, self.value='0b0001', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTB', 'pin': 'AFIO_PIN13'}, self.value='0b0001', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTB', 'pin': 'AFIO_PIN14'}, self.value='0b0001', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTB', 'pin': 'AFIO_PIN15'}, self.value='0b0001', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
  ...
  // scope=self.reg='EXTICR[0]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTC', 'pin': 'AFIO_PIN0'}, self.value='0b0010', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[0]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTC', 'pin': 'AFIO_PIN1'}, self.value='0b0010', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[0]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTC', 'pin': 'AFIO_PIN2'}, self.value='0b0010', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[0]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTC', 'pin': 'AFIO_PIN3'}, self.value='0b0010', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTC', 'pin': 'AFIO_PIN4'}, self.value='0b0010', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTC', 'pin': 'AFIO_PIN5'}, self.value='0b0010', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTC', 'pin': 'AFIO_PIN6'}, self.value='0b0010', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTC', 'pin': 'AFIO_PIN7'}, self.value='0b0010', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTC', 'pin': 'AFIO_PIN8'}, self.value='0b0010', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTC', 'pin': 'AFIO_PIN9'}, self.value='0b0010', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTC', 'pin': 'AFIO_PIN10'}, self.value='0b0010', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTC', 'pin': 'AFIO_PIN11'}, self.value='0b0010', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTC', 'pin': 'AFIO_PIN12'}, self.value='0b0010', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTC', 'pin': 'AFIO_PIN13'}, self.value='0b0010', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTC', 'pin': 'AFIO_PIN14'}, self.value='0b0010', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTC', 'pin': 'AFIO_PIN15'}, self.value='0b0010', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
  ...
  // scope=self.reg='EXTICR[0]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTD', 'pin': 'AFIO_PIN0'}, self.value='0b0011', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[0]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTD', 'pin': 'AFIO_PIN1'}, self.value='0b0011', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[0]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTD', 'pin': 'AFIO_PIN2'}, self.value='0b0011', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[0]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTD', 'pin': 'AFIO_PIN3'}, self.value='0b0011', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTD', 'pin': 'AFIO_PIN4'}, self.value='0b0011', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTD', 'pin': 'AFIO_PIN5'}, self.value='0b0011', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTD', 'pin': 'AFIO_PIN6'}, self.value='0b0011', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTD', 'pin': 'AFIO_PIN7'}, self.value='0b0011', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTD', 'pin': 'AFIO_PIN8'}, self.value='0b0011', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTD', 'pin': 'AFIO_PIN9'}, self.value='0b0011', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTD', 'pin': 'AFIO_PIN10'}, self.value='0b0011', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTD', 'pin': 'AFIO_PIN11'}, self.value='0b0011', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTD', 'pin': 'AFIO_PIN12'}, self.value='0b0011', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTD', 'pin': 'AFIO_PIN13'}, self.value='0b0011', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTD', 'pin': 'AFIO_PIN14'}, self.value='0b0011', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTD', 'pin': 'AFIO_PIN15'}, self.value='0b0011', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
  ...
  // scope=self.reg='EXTICR[0]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTE', 'pin': 'AFIO_PIN0'}, self.value='0b0100', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[0]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTE', 'pin': 'AFIO_PIN1'}, self.value='0b0100', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[0]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTE', 'pin': 'AFIO_PIN2'}, self.value='0b0100', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[0]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTE', 'pin': 'AFIO_PIN3'}, self.value='0b0100', self.ifdef=[], self.halt=False
  AFIO->EXTICR[0] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTE', 'pin': 'AFIO_PIN4'}, self.value='0b0100', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTE', 'pin': 'AFIO_PIN5'}, self.value='0b0100', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTE', 'pin': 'AFIO_PIN6'}, self.value='0b0100', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[1]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTE', 'pin': 'AFIO_PIN7'}, self.value='0b0100', self.ifdef=[], self.halt=False
  AFIO->EXTICR[1] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTE', 'pin': 'AFIO_PIN8'}, self.value='0b0100', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTE', 'pin': 'AFIO_PIN9'}, self.value='0b0100', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTE', 'pin': 'AFIO_PIN10'}, self.value='0b0100', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[2]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTE', 'pin': 'AFIO_PIN11'}, self.value='0b0100', self.ifdef=[], self.halt=False
  AFIO->EXTICR[2] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=0, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTE', 'pin': 'AFIO_PIN12'}, self.value='0b0100', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=4, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTE', 'pin': 'AFIO_PIN13'}, self.value='0b0100', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=8, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTE', 'pin': 'AFIO_PIN14'}, self.value='0b0100', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
  ...
  // scope=self.reg='EXTICR[3]', self.shift=12, self.mask='0xf', self.varsmap={'port': 'AFIO_PORTE', 'pin': 'AFIO_PIN15'}, self.value='0b0100', self.ifdef=[], self.halt=False
  AFIO->EXTICR[3] = 0;
