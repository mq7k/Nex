...
test_reg_addr(void)
{
  ASSERT_OFFSET(struct hash_registers_map, CR, 0x00lu);
  ASSERT_OFFSET(struct hash_registers_map, DIN, 0x04lu);
  ASSERT_OFFSET(struct hash_registers_map, STR, 0x08lu);
  ASSERT_OFFSET(struct hash_registers_map, HRA[0], 0x0clu);
  ASSERT_OFFSET(struct hash_registers_map, HRA[1], 0x10lu);
  ASSERT_OFFSET(struct hash_registers_map, IMR, 0x20lu);
  ASSERT_OFFSET(struct hash_registers_map, SR, 0x24lu);
}
